...
- Panel review **complements** existing skills, doesn't replace them. For deep security work prefer `cacack:security-review`. For simplification prefer the built-in `/simplify`. Panel review is the broad-survey first pass.

...
This ensures these files follow the Handyman Principle (context is scarce), contain accurate references, apply path-scoping appropriately, and provide clear, actionable project instructions. (To author or migrate these files rather than audit them, use `/cacack:create-claudemd`.)
</objective>

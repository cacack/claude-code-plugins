...
description: Adversarial code reviewer focused on bug-hunting, edge cases, and error-handling gaps. Intended for use within delivery:panel-review where 6 reviewers run in parallel; the orchestrator passes a diff file path.
